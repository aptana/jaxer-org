...
<div style="display:none;">
	at this time this is the beginning of a guidelines/visual vocabulary page
</div>
...
<div id="section-content" class="guide guide-content devices">
	...
	<div class="snippet">
		<div class="snippet-header">But snippets likely will not have headers</div>
		<textarea class="snippet-source">
			blue or gray (maybe white with dotted border)
			snippet - 5 lines or less
		</textarea>
	</div>
	
	<div class="listing">
		<div class="listing-header">Listing : Performing a Callback</div>
		<div class="listing-header">Listing : Including a Page</div>
		<div class="listing-body">
			<div class="listing-preface"></div>
			<textarea class="listing-source">
				blue or gray (maybe white with dotted border)
				listing - more than 5 lines
				using lightbox or inline expansion - but needs to be printable?
				lightbox adds too much complexity now relating to printing
			</textarea>
		</div>
	...
	<div style="display:none;">
		snippet and listing sections will need to be entirely 
		every listing must have a header
		for listings, heading will be a disclosure triangle at left for now
		later for lightbox change change to a mag glass
		perhaps be able to auto determine whether to do inline or not 
		numbered sections?
		use darker border for all boxes
		lorem ipsum
		for now - forget about using sh but have a separate test
		also - listings really need to have there trigger header on a new line
		consider turning on underlines for links
		when to use bolding and when to use code
		should be using code tag or tt?
	</div>
